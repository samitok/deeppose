...
tf.app.flags.DEFINE_string('eval_dir', pt.expanduser('~/Desktop/LSP_data/EvalData/'),  """Directory where to write event logs.""")
...
tf.app.flags.DEFINE_integer('label_size', 3, """Label size of images""")
...
tf.app.flags.DEFINE_integer('num_epochs_per_decay', 500, """Epochs after which learning rate decays""")
tf.app.flags.DEFINE_integer('learn_decay_factor', 0.1, """Learning rate decay factor""")
tf.app.flags.DEFINE_integer('initial_learn_rate', 0.01, """Initial learning rate""")
tf.app.flags.DEFINE_integer('example_per_epoch', 100, """Number of Examples per Epoch for Train""")
