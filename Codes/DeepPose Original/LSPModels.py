...
def inference(images, batch_size, keepProb=1):
    ...
    with tf.variable_scope('conv1') as scope:
        ...
        biases = tf.Variable(tf.constant(0.0, dtype=tf.float32, shape=[48]), name='biases')
    ...
    with tf.variable_scope('conv2') as scope:
        ...
        biases = tf.Variable(tf.constant(0.1, dtype=tf.float32, shape=[128]), name='biases')
    ...
    with tf.variable_scope('conv3') as scope:
        kernel = tf.Variable(tf.random_normal([3, 3, 128, 192], stddev=1e-4), name='weights')
    ...
    with tf.variable_scope('conv4') as scope:
        kernel = tf.Variable(tf.random_normal([3, 3, 192, 192], stddev=1e-4), name='weights')
    ...
    with tf.variable_scope('conv5') as scope:
        kernel = tf.Variable(tf.random_normal([5, 5, 192, 128], stddev=1e-4), name='weights')
