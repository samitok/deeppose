...
tf.app.flags.DEFINE_string('orimage_dir', pt.expanduser('~/Desktop/LSP_data/images/'),
                           """Folder for saving resized train files""")
tf.app.flags.DEFINE_string('train_dir', pt.expanduser('~/Desktop/LSP_data/TrainData'),
                           """Folder for saving train files""")
tf.app.flags.DEFINE_string('input_dir', pt.expanduser('~/Desktop/LSP_data/EvalData/'),
                           """Input images directory.""")
tf.app.flags.DEFINE_string('output_dir', pt.expanduser('~/Desktop/LSP_data/EvalData/Drawings'),
                           """Output images directory.""")
tf.app.flags.DEFINE_string('drawing_dir', pt.expanduser('~/Desktop/LSP_data/TrainData/Drawings'),
                           """Folder for saving train files""")
...
tf.app.flags.DEFINE_integer('train_set_ratio', 0.8, """Ratio of number of train images""")
tf.app.flags.DEFINE_integer('validation_set_ratio', 0.1, """Ratio of number of validation images""")
tf.app.flags.DEFINE_integer('test_set_ratio', 0.1, """Ratio of number of test images""")

tf.app.flags.DEFINE_integer('input_size', 220, """One side of CNN's input image size""")
